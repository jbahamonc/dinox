...
<head>
	...
	<title>Dinox | Soporte técnico para equipos de computo</title>
...
<body>	
	<!-- Inicio Header -->
	<header class="web extended amber">
		...
		<div class="nav-wrapper db">
			<div class="nav-header center">
	          	<h1 class="white-text">COMPUTADORES</h1>
	          	<div class="ge">Soporte Tecnico</div>
	        </div>
		</div>
	...
	<main style="background-color: #EEE;">
		<div class="container">
			<div class="wrapper-service">
				<div class="c-top">
					<h3 class="center">Soporte Tecnico para Equipos de Computo</h3>
					<img src="../img/soporte-tecnico.jpg" alt="Soporte Tecnico para Equipos de Computo" class="responsive-img">
					<p class="lead margin-bottom-40">Si su equipo de computo ya NO tiene el mismo rendimiento ni la misma velocidad que antes, o se bloquea con frecuencia, es conveniente que se cerciore sobre el estado real en el que se encuentra.</p>
				</div>
				<p>Nuestro servicio de Revisión Diagnóstica le permitirá tener en sus manos un Informe Detallado acerca del estado real de su equipo de cómputo. Con esta información usted sabrá exactamente que procedimiento se debe seguir para solucionar el inconveniente técnico.</p><br>
				<p><b>Importante!</b></p>
				<p>Mantenga en un óptimo rendimiento los equipos de su empresa u hogar, con Antivirus y Sistemas Operativos limpios y actualizados.</p>
				<br>
				<p><b>Que realizamos</b></p>
				<p>- Limpieza de Virus, Spyware y Troyanos.</p>
				<p>- Instalación de Software y Hardware.</p>
				<p>- Ensamble, actualización de PCs.</p>
				<p>- Mantenimiento, configuración de Sistemas Operativos.</p>
				<p>- Configuración de Acceso a Internet.</p>
				<p>- Optimización de Windows.</p>
				<p>- Resguardo de Información o copias de Seguridad (Backup)</p>
				<br><br>
			...
			<div class="center padin-bottom-40">
				<a href="../#contacto" class="btn btn-large  waves-effect waves-light amber">iniciar proyecto</a>
			</div>
		</div>
	</main>
	<!-- Footer -->
